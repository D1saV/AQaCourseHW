(function (N, O) {
  ...
  function na(a, c, b, d) {
    ...
    function f(a, b, d) {
      ...
      n.started = !0;
      var c = C(a) ? a : [a];
      void 0 !== a && c.length ? ((r = d), (m = b), Q(c, e), (m = void 0)) : n.idle() && D(n.drain);
    }
    function g(a, b) {
      var d = !1;
      return function (c, e) {
    ...
    function q() {
      for (; !n.paused && h < n.concurrency && n._tasks.length; ) {
        for (
          var a = n._tasks.splice(n.payload || n._tasks.length), b = -1, d = a.length, e = Array(d);
          ++b < d;
    ...
    var h = 0,
      ...
      n = {
        ...
        resume: function () {
          !1 !== n.paused &&
            ((n.paused = !1),
            K(n.concurrency < n._tasks.length ? n.concurrency : n._tasks.length, s));
        },
        _worker: c,
      };
    return n;
        ...
        C(d)
          ...
          : d &&
            (z && d[z]
              ...
              : 'object' === typeof d &&
                ((s = F(d)), (q = s.length), (h = void 0 !== e ? e : {}), c(d, h, f, l, s)));
        ...
        C(a)
          ...
          : a &&
            (z && a[z]
              ...
              : 'object' === typeof a &&
                ((u = F(a)), (k = u.length), (p = Array(k)), (y = 3 === b.length ? s : q)));
        if (!k || isNaN(c) || 1 > c) return d(null, []);
        x = x || Array(k);
        K(c > k ? k : c, y);
      },
