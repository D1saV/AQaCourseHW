!(function (r, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports"], e)
    : e(
        ((r = "undefined" != typeof globalThis ? globalThis : r || self).uuid =
          {}),
      );
})(this, function (r) {
  "use strict";
  ...
  for (var i, u, f = [], s = 0; s < 256; ++s)
    f.push((s + 256).toString(16).substr(1));
  function c(r) {
  ...
  var U = p("v3", 48, function (r) {
    ...
    return (function (r) {
      for (
        var e = [], n = 32 * r.length, t = "0123456789abcdef", o = 0;
        o < n;
        o += 8
      ) {
      ...
      (function (r, e) {
        ...
        (function (r) {
          ...
          for (
            var e = 8 * r.length, n = new Uint32Array(h(e)), t = 0;
            t < e;
            t += 8
          )
  ...
  var R = p("v5", 80, function (r) {
    ...
    r.push(128);
    for (
      var a = r.length / 4 + 2, i = Math.ceil(a / 16), u = new Array(i), f = 0;
      f < i;
      ++f
    ) {
    ...
    for (var l = 0; l < i; ++l) {
      ...
      for (
        var h = n[0], y = n[1], g = n[2], m = n[3], w = n[4], b = 0;
        b < 80;
        ++b
      ) {
